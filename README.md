...
- **프렌즈홈 생성**: 메인 화면 우하단 "새 프렌즈홈 만들기" 또는 상단 드롭다운에서 "새 프렌즈홈 만들기"로 제목을 입력해 생성.
...
- **4·5번(소식, 임시 게시판)**: 프렌즈홈 비밀번호 입력 후 열람·글쓰기. 비밀번호 미설정 시 기본 `friends`.
- **데이터**: 브라우저 **localStorage**·**sessionStorage**에 저장.
